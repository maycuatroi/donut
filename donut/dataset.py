...
class DonutDataset(Dataset):
    ...
    def __init__(
            ...
            donut_processor: DonutProcessor = None,
            donut_model: VisionEncoderDecoderModel = None,
    ):
        super().__init__()
        ...
        self.processor = donut_processor
        self.model = donut_model
        ...
        self.prompt_end_token_id = donut_processor.tokenizer.convert_tokens_to_ids(self.prompt_end_token)
...
if __name__ == '__main__':
    ...
    dataset_name = '../../data/vn-menu'

    processor.feature_extractor.size = [960, 1280]  # should be (width, height)
    processor.feature_extractor.do_align_long_axis = False
    max_length = 768
    token_prom = "<s_menu-vn>"
    train_dataset = DonutDataset(dataset_name, max_length=max_length,
                                 split="train", task_start_token=token_prom, prompt_end_token=token_prom,
                                 sort_json_key=False,  # cord dataset is preprocessed, so no need for this
                                 donut_processor=processor,
                                 donut_model=VisionEncoderDecoderModel.from_pretrained("nielsr/donut-demo"))
    train_dataset[0]
